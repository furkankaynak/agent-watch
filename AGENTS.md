...
- **Hook Sistemi**: `hooks/generic-hook.js` 21 Cursor hook'unu yakalar, stdin'den JSON okur, alanları düzleştirir, `POST /api/ingest` ile server'a gönderir. Her zaman exit 0 (fail-open).
...
Her yeni özellik, yeni komut, yeni dizin veya mimari değişiklik sonrası bu dosyayı güncelle. Özellikle:
- Yeni bir script/komut eklendiyse Komutlar tablosuna ekle
- Yeni bir dizin/modül eklendiyse Dizin Yapısı'na ekle
- Mimari bir karar değiştiyse ilgili bölümü güncelle
